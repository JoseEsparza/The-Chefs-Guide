...
<html lang="en" ng-app='TCG'>
	...
	<body ng-controller='main'>
		...
		<div id="Register" class="row">
			...
			<div class="data2 col-md-offset-3 col-md-6">
				<div class="user_i form-group col-md-6">
					<input class="form-control" type="text" name="name" placeholder="Nombre">
					<input class="form-control" type="text" name="email" placeholder="Correo electr&oacute;nico">
					...
					<a class="btn_db col-md-12" href="index.php">REGISTRARME</a>
				</div>
				<div class="text-justify benefits col-md-6">
					...
					<a class="btn_db1 col-md-12" href="Login.php">ENTRAR</a>
				</div>
			</div>
		</div>
